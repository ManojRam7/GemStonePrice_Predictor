...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv('/Users/manojrammopati/Project/DATA SCIENCE ML PROJECTS/GemstonePrice_Predictor/artifacts/train.csv')  # Replace with the actual path to your train data
    test_df = pd.read_csv('/Users/manojrammopati/Project/DATA SCIENCE ML PROJECTS/GemstonePrice_Predictor/artifacts/test.csv')    # Replace with the actual path to your test data

    # Load the preprocessor
    with open('/Users/manojrammopati/Project/DATA SCIENCE ML PROJECTS/GemstonePrice_Predictor/artifacts/preprocessor.pkl', 'rb') as file:
    ...
    logging.info(f'train_array shape: {train_array.shape}, test_array shape: {test_array.shape}')
...
class ModelTrainer:
    ...
    def initate_model_training(self, train_array, test_array):
        try:
            ...
            model_report: dict = evaluate_models(xtrain, ytrain, xtest, ytrain, models)
            ...
            er.fit(xtrain, ytrain)
            print('Final Model Evaluation:\n')
            print_evaluated_results(xtrain, ytrain, xtest, ytrain, er)
            logging.info('Voting Regressor Training Completed')
            ...
            ytest_pred = er.predict(xtest)
            mae, rmse, r2 = model_metrics(ytrain, ytest_pred)
            logging.info(f'Test MAE: {mae}')
            logging.info(f'Test RMSE: {rmse}')
            logging.info(f'Test R2 Score: {r2}')
            logging.info('Final Model Training Completed')
