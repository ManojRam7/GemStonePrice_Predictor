...
if __name__ == "__main__":
    ...
    train_path = '/Users/manojrammopati/Project/DATA SCIENCE ML PROJECTS/GemstonePrice_Predictor/artifacts/train.csv'  # Replace with the actual path to your training data
    test_path = '/Users/manojrammopati/Project/DATA SCIENCE ML PROJECTS/GemstonePrice_Predictor/artifacts/test.csv'    # Replace with the actual path to your testing data
